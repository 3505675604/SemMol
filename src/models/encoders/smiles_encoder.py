...
class SMILESEncoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        mode: str = PRETRAINED_ADAPTER_MODE,
        ...
        revision: str = "main",
        scratch_hidden_size: int = 512,
        scratch_num_hidden_layers: int = 6,
        scratch_num_attention_heads: int = 8,
        scratch_intermediate_size: int = 2048,
